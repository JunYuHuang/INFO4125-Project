...
// nav menu, nav menu button, and nav menu button icon
...
const productSearchInput = document.querySelector(".input--search");
const productCardGrid = document.querySelector(".card-grid-container");
