    ...
    <header class="header">
      <nav role="navigation" class="navbar">
        <div class="logo-wrapper">
          <a href="/~webdevgp6/INFO4125-Project/" class="logo__link">
            <img class="logo-icon" src="/~webdevgp6/INFO4125-Project/assets/images/favicon.png" alt="An thumbnail image of the Penzaar brand.">
            <h1 class="logo uppercase">Penzaar</h1>
          </a>
        </div>
        <ul class="nav-menu">
          <li class="nav-menu__item">
            <a href="/~webdevgp6/INFO4125-Project/products" class="nav-menu__item__link">Products</a>
          </li>
          <li class="nav-menu__item">
            <a href="/~webdevgp6/INFO4125-Project/views/about.php" class="nav-menu__item__link">About</a>
          </li>
          <li class="nav-menu__item">
            <a href="/~webdevgp6/INFO4125-Project/views/contact.php" class="nav-menu__item__link">Contact</a>
          </li>
        </ul>
        <div class="nav-special-icons">
          <a
            href="/~webdevgp6/INFO4125-Project/cart"
          ...
          >
            <div class="icon-wrapper--nav">
              <img
                src="/~webdevgp6/INFO4125-Project/assets/images/cart.svg"
          ...
          >
            <img
              src="/~webdevgp6/INFO4125-Project/assets/images/icon-hamburger.svg"
            ...
            />
            <img
              src="/~webdevgp6/INFO4125-Project/assets/images/icon-close.svg"
