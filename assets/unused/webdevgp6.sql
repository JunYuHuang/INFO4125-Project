...
INSERT INTO `customer_info` (`fname`, `lname`, `email`, `phoNo`, `country`, `postalCode`, `street`, `unit`, `city`, `province`) VALUES
('John', 'Smith', 'john.smith@example.com', '123-568-7890', 'Canada', 'V7E3P4', 'Elm Street', '5100', 'Surrey', 'BC');
...
INSERT INTO `inventory` (`pen_id`, `name`, `ink_color`, `size`, `price`) VALUES
